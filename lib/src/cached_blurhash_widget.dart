...
/// of [duration].
class CachedBlurhash extends StatefulWidget {
  const CachedBlurhash({
    required this.hash,
    Key? key,
    ...
    this.errorBuilder,
    this.optimizationMode = CachedBlurhashOptimizationMode.none,
  ...
  final CachedBlurhashOptimizationMode optimizationMode;

  @override
  CachedBlurhashState createState() => CachedBlurhashState();
}

class CachedBlurhashState extends State<CachedBlurhash> {
  ...
  @override
  void didUpdateWidget(CachedBlurhash oldWidget) {
  ...
  void _decodeImage() {
    _image = cachedBlurhashDecodeImage(
  ...
  Widget build(BuildContext context) => Stack(
        ...
        children: [
          buildCachedBlurhashBackground(),
          if (widget.image != null) prepareDisplayedImage(widget.image!),
        ],
      );

  Widget prepareDisplayedImage(String image) => CachedNetworkImage(
        imageUrl: image,
        fit: widget.imageFit,
        ...
        imageBuilder: (context, imageProvider) {
          ...
          return _DisplayImage(
            child: Image(image: imageProvider, fit: widget.imageFit),
  ...
  Widget buildCachedBlurhashBackground() => FutureBuilder<ui.Image>(
        future: _image,
