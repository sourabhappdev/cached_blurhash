...
enum CachedBlurhashOptimizationMode {
  /// Original algorithm
  none,
...
Future<Uint8List> cachedBlurhashDecode({
  required String blurHash,
  required int width,
  required int height,
  double punch = 1.0,
...
Future<ui.Image> cachedBlurhashDecodeImage({
  required String blurHash,
  required int width,
  required int height,
  double punch = 1.0,
  ...
  if (optimizationMode != CachedBlurhashOptimizationMode.none) {
    pixels = await optimizedCachedBlurhashDecode(
      blurHash: blurHash,
      width: width,
      height: height,
      punch: punch,
    ...
    pixels = await cachedBlurhashDecode(
      blurHash: blurHash,
      width: width,
      height: height,
      punch: punch,
